...
// Digital pin 3 (PWM)    SWITCH 7 
// Digital pin 4          SWITCH 8
// Digital pin 5 (PWM)    SWITCH 9
// Digital pin 6 (PWM)    SWITCH 10
// Digital pin 7          SWITCH 11
// Digital pin 8          SWITCH 12
...
// module name
unsigned char mname[8] = { '1', '2', 'I', 'N', '0', 'O', 'U', 'T' };
...
const byte LED[] = {  };     // LED pin connections through a 1K8 resistor
const byte SWITCH[] = {3, 4, 5, 6, 7, 8, A0, A1, A2, A3, A4, A5 };  // Module Switch takes input to 0V.

...
// Digital / Analog pin 0     LED 7
// Digital / Analog pin 1     LED 8
// Digital / Analog pin 2     LED 9
// Digital / Analog pin 3     LED 10
// Digital / Analog pin 4     LED 11
// Digital / Analog pin 5     LED 12
//////////////////////////////////////////////////////////////////////////

// 12in0out setup for seperate module by John Holmes only small changes to original sketch
...
// module name
unsigned char mname[8] = { '0', 'I', 'N', '1', '2', 'O', 'U', 'T' };
...
const byte LED[] = { 3, 4, 5, 6, 7, 8, A0, A1, A2, A3, A4, A5 };     // LED pin connections through a 1K8 resistor
const byte SWITCH[] = { };  // Module Switch takes input to 0V.
